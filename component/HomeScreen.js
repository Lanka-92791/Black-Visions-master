  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.categoryContainer}>
        ...
        >
          <View style={styles.categoryIcon}>
            <Ionicons name="ios-restaurant" size={35} color="black" />
          </View>
      ...
      <View style={[styles.categoryContainer, { marginTop: 10 }]}>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          <View style={styles.categoryIcon}>
            <Fontisto name="hotel" size={35} color="black" />
          </View>
          <Text style={styles.categoryBtnTxt}>Hotels</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.categoryBtn} onPress={() => {}}>
          <View style={styles.categoryIcon}>
            <Ionicons name="md-restaurant" size={35} color="black" />
          </View>
      ...
      <View style={styles.cardsWrapper}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}>Hotel 1</Text>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardTitle}>Hotel 2</Text>
